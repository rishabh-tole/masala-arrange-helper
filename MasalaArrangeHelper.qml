...
MuseScore {
    ...
    implicitWidth: 980
    implicitHeight: 760
    width: root.hostWindow ? root.hostWindow.width : root.implicitWidth
    height: root.hostWindow ? root.hostWindow.height : root.implicitHeight

    // MuseScore 4.6 opens every legacy form plugin in a non-resizable dialog,
    // including plugins declared as "dock". Clear that host window size lock
    // after its wrapper finishes opening so this responsive UI can resize.
    property var hostWindow: Window.window
    property int resizeUnlockAttempts: 0

    function unlockHostWindowResize() {
        if (!hostWindow)
            return
        hostWindow.minimumWidth = 520
        hostWindow.minimumHeight = 420
        hostWindow.maximumWidth = 16777215
        hostWindow.maximumHeight = 16777215
    }

    onHostWindowChanged: {
        resizeUnlockAttempts = 0
        resizeUnlockTimer.restart()
    }
    ...
    property bool narrowLayout: width < 860
    ...
    property var previewVoiceDefinitions: [
        { id: "t1", label: "T1", clef: "treble" },
        { id: "t2", label: "T2", clef: "treble" },
        { id: "bari", label: "Baritone", clef: "treble" },
        { id: "bass", label: "Bass", clef: "bass" }
    ]
    ...
    Timer {
        id: resizeUnlockTimer
        interval: 100
        repeat: true
        onTriggered: {
            root.unlockHostWindowResize()
            root.resizeUnlockAttempts += 1
            if (root.resizeUnlockAttempts >= 10)
                stop()
        }
    }
            ...
            ColumnLayout {
                ...
                Frame {
                    ...
                    ColumnLayout {
                        ...
                        Flow {
                            ...
                            Row {
                                spacing: 6
                                height: keyCombo.implicitHeight
                            ...
                            Row {
                                spacing: 6
                                height: modeCombo.implicitHeight
                                ...
                                ComboBox {
                                    ...
                                    currentIndex: root.currentModeId === "major" ? 0
                                                  : (root.currentModeId === "naturalMinor" ? 1 : 2)
                                    onActivated: function(index) {
                                        root.currentModeId = index === 0 ? "major"
                                                                  : (index === 1 ? "naturalMinor" : "harmonicMinor")
                                        root.rebuildPalette()
                                    }
                                }
                            }
                ...
                Frame {
                    ...
                    ColumnLayout {
                        ...
                        Flow {
                            ...
                            Layout.preferredHeight: childrenRect.height
                            spacing: 6
                            property int columnCount: width < 520 ? 2 : (root.narrowLayout ? 4 : 7)
                            property real cardWidth: (width - spacing * (columnCount - 1)) / columnCount
                            ...
                            Repeater {
                                ...
                                delegate: Item {
                                    ...
                                    Rectangle {
                                        ...
                                        anchors.fill: parent
                                        radius: 5
                                        color: paletteMouse.containsMouse ? systemPalette.button : systemPalette.base
                                    ...
                                    Rectangle {
                                        ...
                                        opacity: 0.92
                                        property int paletteIndex: paletteCardItem.paletteIndex
                                        ...
                                        Label {
                                            anchors.centerIn: parent
                                            text: roman + "\n" + root.noteNameFromPc(rootPc)
                                                  + root.qualitySuffix(qualityId)
                                    ...
                                    MouseArea {
                                        ...
                                        onClicked: function(mouse) {
                                            if (!moved)
                                                root.addPaletteChord(
                                                    paletteCardItem.paletteIndex,
                                                    progressionModel.count)
                                        }
                                    }
                                }
                            }
                    ...
                    ColumnLayout {
                        ...
                        DropArea {
                            ...
                            Rectangle {
                                ...
                                border.color: progressionDropArea.containsDrag
                            ...
                            Label {
                                anchors.centerIn: parent
                                visible: progressionModel.count === 0
                                text: "Choose chord above"
                                opacity: 0.55
                            }
                            ...
                            ListView {
                                ...
                                delegate: Item {
                                    ...
                                    Rectangle {
                                        ...
                                        anchors.fill: parent
                                        radius: 5
                                        color: root.selectedChordIndex === progressionCardItem.chordIndex
                                               ? systemPalette.highlight : systemPalette.button
                                        border.color: root.selectedChordIndex === progressionCardItem.chordIndex
                                                      ? systemPalette.highlightedText : systemPalette.mid
                                        border.width: root.selectedChordIndex === progressionCardItem.chordIndex ? 2 : 1

                                        Label {
                                            anchors.centerIn: parent
                                            text: roman + "  " + root.chordSymbol(
                                                      progressionModel.get(progressionCardItem.chordIndex))
                                                  + "\n" + root.durationAt(progressionModel.get(
                                                      progressionCardItem.chordIndex).durationIndex).text
                                            color: root.selectedChordIndex === progressionCardItem.chordIndex
                                                   ? systemPalette.highlightedText : systemPalette.buttonText
                                            font.bold: root.selectedChordIndex === progressionCardItem.chordIndex
                                            horizontalAlignment: Text.AlignHCenter
                                        }
                                    }
                                    ...
                                    Rectangle {
                                        ...
                                        border.color: systemPalette.highlightedText
                                        opacity: 0.92
                                        property int chordUid: progressionCardItem.chordUid
                                        ...
                                        Label {
                                            anchors.centerIn: parent
                                            text: root.chordSymbol(progressionModel.get(
                                                      progressionCardItem.chordIndex))
                                            color: systemPalette.highlightedText
                                            font.bold: true
                                        }
                                    }
                                    ...
                                    MouseArea {
                                        ...
                                        onPressed: function(mouse) {
                                            moved = false
                                            root.selectedChordIndex = progressionCardItem.chordIndex
                                            root.touchUi()
                            ...
                            onDropped: function(drop) {
                                ...
                                var targetIndex = Math.floor(
                                    (drop.x + progressionView.contentX) / cardWidth)
                        ...
                        Flow {
                            ...
                            Button {
                                text: "→"
                                enabled: root.selectedChordIndex >= 0
                                         && root.selectedChordIndex < progressionModel.count - 1
                                onClicked: root.moveSelected(1)
                            }
                ...
                GridLayout {
                    ...
                    Frame {
                        ...
                        Layout.preferredWidth: root.narrowLayout ? voicingPreviewGrid.width
                                                                : (voicingPreviewGrid.width - 10) * 0.52
                        ...
                        ColumnLayout {
                            ...
                            Flow {
                                ...
                                Row {
                                    spacing: 4
                                    height: selectedRootCombo.implicitHeight
                                ...
                                Row {
                                    spacing: 4
                                    height: selectedQualityCombo.implicitHeight
                                    ...
                                    ComboBox {
                                        id: selectedQualityCombo
                                        width: 160
                                        enabled: root.selectedChord() !== null
                                        model: root.qualityChoices
                                        textRole: "text"
                                        currentIndex: root.selectedChord()
                                                      ? root.qualityIndex(root.selectedChord().qualityId) : 0
                                        onActivated: function(index) {
                                            root.changeSelectedQuality(root.qualityChoices[index].id)
                                        }
                                    }
                                }
                                ...
                                Row {
                                    spacing: 4
                                    height: selectedDurationCombo.implicitHeight
                                    ...
                                    ComboBox {
                                        id: selectedDurationCombo
                                        width: 126
                                        enabled: root.selectedChord() !== null
                                        model: root.durationDefinitions
                                        textRole: "text"
                                        currentIndex: root.selectedChord()
                                                      ? root.selectedChord().durationIndex : root.defaultDurationIndex
                                        onActivated: function(index) {
                                            root.setSelectedChordProperty("durationIndex", index)
                                        }
                                    }
                                }
                            }
                            ...
                            Repeater {
                                model: root.previewVoiceDefinitions
                                ...
                                delegate: RowLayout {
                                    ...
                                    ComboBox {
                                        ...
                                        currentIndex: root.selectedChord()
                                                      ? root.getVoiceTone(root.selectedChord(), voiceId) : 0
                                        onActivated: function(index) {
                                            root.setSelectedVoiceTone(voiceId, index)
                                        }
                                    }
                                    ...
                                    SpinBox {
                                        ...
                                        editable: true
                                        enabled: root.selectedChord() !== null
                                        value: root.selectedChord()
                                               ? root.getVoiceOctave(root.selectedChord(), voiceId) : 3
                            ...
                            Rectangle {
                                Layout.fillWidth: true
                                Layout.preferredHeight: Math.max(38, voicingCheckLabel.implicitHeight + 12)
                                radius: 5
                                color: systemPalette.base
                                border.color: systemPalette.mid

                                Label {
                                    id: voicingCheckLabel
                    ...
                    Frame {
                        ...
                        Layout.alignment: Qt.AlignTop
                        Layout.preferredWidth: root.narrowLayout ? voicingPreviewGrid.width
                                                                : (voicingPreviewGrid.width - 10) * 0.48
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                Label {
                                    text: root.selectedChord() ? root.chordSymbol(root.selectedChord()) : "No chord"
                                    font.bold: true
                                }
                            }
                            ...
                            Label {
                                Layout.fillWidth: true
                                text: "T1, T2, Baritone: treble clef · Bass: bass clef"
                                wrapMode: Text.WordWrap
                                opacity: 0.65
                                font.pixelSize: 11
                            }
                            ...
                            Rectangle {
                                ...
                                Canvas {
                                    ...
                                    onPaint: {
                                        ...
                                        var ink = "" + systemPalette.text
                                        var muted = "" + systemPalette.mid
                                        var warning = "#c44949"
                                        var rowHeight = height / root.previewVoiceDefinitions.length
                                        var staffLeft = 76
                                        var staffRight = Math.max(staffLeft + 150, width - 68)
                                        var lineGap = 8
                                        var noteX = staffLeft + (staffRight - staffLeft) * 0.64
                                        var chord = root.selectedChord()

                                        context.lineCap = "round"
                                        context.textBaseline = "middle"

                                        for (var voiceIndex = 0;
                                             voiceIndex < root.previewVoiceDefinitions.length;
                                             ++voiceIndex) {
                                            var voice = root.previewVoiceDefinitions[voiceIndex]
                                            var rowTop = voiceIndex * rowHeight
                                            var bottomY = rowTop + 57

                                            context.strokeStyle = muted
                                            context.lineWidth = 1
                                            for (var line = 0; line < 5; ++line) {
                                                var lineY = bottomY - line * lineGap
                                                context.beginPath()
                                            ...
                                            context.fillText(voice.label, 8, rowTop + 48)

                                            context.font = "40px Bravura"
                                            context.fillText(voice.clef === "bass" ? "𝄢" : "𝄞",
                                                             staffLeft + 5, rowTop + 42)

                                            if (!chord)
                                                continue

                                            var pitch = root.selectedVoicePitch(voice.id)
                                            var step = StaffPreview.staffStepFromBottom(
                                                        pitch, voice.clef, root.preferFlats)
                                            var noteY = bottomY - step * lineGap / 2
                                            var ledgerLines = StaffPreview.ledgerSteps(step)
                                            var voiceRange = root.voiceDefinition(voice.id)
                                            var noteInk = pitch < voiceRange.min || pitch > voiceRange.max
                                                           ? warning : ink

                                            context.strokeStyle = noteInk
                                            context.lineWidth = 1.4
                                            for (var ledgerIndex = 0;
                                                 ledgerIndex < ledgerLines.length;
                                                 ++ledgerIndex) {
                                                var ledgerY = bottomY
                                                              - ledgerLines[ledgerIndex] * lineGap / 2
                                                context.beginPath()
                                                context.moveTo(noteX - 12, ledgerY)
                                                context.lineTo(noteX + 12, ledgerY)
                                                context.stroke()
                                            }

                                            var accidental = StaffPreview.accidental(
                                                                pitch, root.preferFlats)
                                            if (accidental.length > 0) {
                                                context.fillStyle = noteInk
                                                context.textAlign = "center"
                                                context.font = "19px sans-serif"
                                                context.fillText(accidental, noteX - 15, noteY)
                                            }

                                            context.save()
                                            context.translate(noteX, noteY)
                                            context.rotate(-0.22)
                                            context.scale(1.15, 0.78)
                                            context.beginPath()
                                            context.arc(0, 0, 5.4, 0, Math.PI * 2, false)
                                            context.fillStyle = noteInk
                                            context.fill()
                                            context.restore()
                                            ...
                                            context.beginPath()
                                            if (step >= 4) {
                                                context.moveTo(noteX - 5, noteY)
                                                context.lineTo(noteX - 5, noteY + 25)
                                            } else {
                                                context.moveTo(noteX + 5, noteY)
                                                context.lineTo(noteX + 5, noteY - 25)
                                            }
                                            ...
                                            context.font = "bold 12px sans-serif"
                                            context.fillText(
                                                StaffPreview.noteName(pitch, root.preferFlats),
                                                width - 7, rowTop + 48)
                                        }
                                    }
                                }
                ...
                Frame {
                    ...
                    ColumnLayout {
                        ...
                        Flow {
                            ...
                            Row {
                                spacing: 5
                                height: defaultDurationCombo.implicitHeight

                                Label {
                                    anchors.verticalCenter: parent.verticalCenter
                                    text: "New chord length"
                                }

                                ComboBox {
                                    id: defaultDurationCombo
                                    width: 130
                                    model: root.durationDefinitions
                                    textRole: "text"
                                    currentIndex: root.defaultDurationIndex
                                    onActivated: function(index) {
                                        root.defaultDurationIndex = index
                                    }
                                }
                            }

                            Button {
                                text: "Add custom chord"
                            ...
                            Repeater {
                                ...
                                delegate: RowLayout {
                                    ...
                                    SpinBox {
                                        ...
                                        editable: true
                                        value: root.staffNumberForVoice(voiceId)
                                        onValueModified: root.setStaffNumberForVoice(voiceId, value)
                                    }
                                }
                            }
                        }
                ...
                Rectangle {
                    Layout.fillWidth: true
                    Layout.preferredHeight: Math.max(38, statusLabel.implicitHeight + 14)
                    radius: 5
